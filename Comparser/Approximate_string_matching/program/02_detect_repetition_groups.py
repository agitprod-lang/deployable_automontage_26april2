...
from lib.stages import run_stage_02


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Stage 02: detect repetition groups.")
...
def main() -> None:
    args = parse_args()
    summary = run_stage_02(args.input, args.output)
    print(summary)
