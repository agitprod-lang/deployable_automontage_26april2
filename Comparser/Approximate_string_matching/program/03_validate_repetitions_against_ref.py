...
from lib.stages import run_stage_03


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Stage 03: validate repetition groups against HTML reference.")
...
def main() -> None:
    args = parse_args()
    summary = run_stage_03(args.input, args.html, args.output)
    print(summary)
