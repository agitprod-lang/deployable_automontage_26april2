...
from lib.stages import run_stage_04


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Stage 04: build backward anchor map.")
...
def main() -> None:
    args = parse_args()
    summary = run_stage_04(args.input, args.html, args.output)
    print(summary)
